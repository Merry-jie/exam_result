  ...
  const styles = `
    * {
    ...
    .half-circle-container {
      position: absolute;
      bottom: -200px;  /* ajusté pour le nouveau diamètre */
      left: 50%;
      transform: translateX(-50%);
      width: 380px;    /* agrandi (anciennement 300px) */
      height: 380px;   /* agrandi */
      z-index: 5;
      overflow: hidden;
      pointer-events: auto;
    }
    ...
    /* Message de survol pour le deuxième cercle */
    .hover-message {
      position: absolute;
      bottom: -30px;
      left: 50%;
    ...
    /* ========== CONTENU TEXTE (réduit et moins d'espace) ========== */
    .spline-content {
      position: absolute;
      bottom: 1.5rem;      /* moins d'espace */
      left: 0;
      right: 0;
      z-index: 10;
      text-align: center;
      ...
      pointer-events: none; /* laisse passer les événements vers les iframes */
    }

    .spline-content h1 {
      font-size: clamp(1.2rem, 3vw, 2rem); /* plus petit qu'avant */
      font-weight: 900;
      margin: 0.5rem 0;      /* moins d'espace vertical */
    ...
    .btn-submit {
      ...
      border: none;
      border-radius: 15px;
      padding: 0.8rem 1.8rem; /* légèrement plus petit */
      ...
      z-index: 15;
      position: relative;
      margin-top: 0.25rem;   /* espace réduit */
